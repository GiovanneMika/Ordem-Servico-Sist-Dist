...
public class OrdemServicoController {
	...
	public static JSONObject realizarEdicaoOrdem(JSONObject entrada) {
		...
		boolean sucesso = OrdemServicoDB.editarOrdemServico(id, usuario.getUsuario(), usuario.getPerfil(),
				novaDescricao, "pendente");
		if (sucesso) {
			resposta.put("status", "sucesso");
	...
	public static JSONObject realizarAlteracaoStatusOrdem(JSONObject entrada) {
		...
		int id = idLong.intValue();
		String resultado = OrdemServicoDB.alterarOrdem(id, novoStatus, novaDescricao, usuario.getPerfil());
